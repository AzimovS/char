...
export type BatchEvent = { type: "batchStarted"; session_id: string } | { type: "batchCompleted"; session_id: string } | { type: "batchResponse"; session_id: string; response: BatchResponse; mode: BatchRunMode } | { type: "batchProgress"; session_id: string; response: StreamResponse; percentage: number } | { type: "batchChunkProgress"; session_id: string; chunk: number; total_chunks: number; percentage: number } | { type: "batchFailed"; session_id: string; code: BatchErrorCode; error: string }
